...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                //unit
                .requestMatchers(HttpMethod.POST, "/api/v1/training-unit/**").hasAnyAuthority("CREATE_SYLLABUS", "FULLACCESS_SYLLABUS")
                .requestMatchers(HttpMethod.GET, "/api/v1/training-unit/**").hasAnyAuthority("VIEW_SYLLABUS", "FULLACCESS_SYLLABUS")
                .requestMatchers(HttpMethod.PATCH, "/api/v1/training-unit/**").hasAnyAuthority("MODIFY_SYLLABUS", "FULLACCESS_SYLLABUS")
                .requestMatchers(HttpMethod.PUT, "/api/v1/training-unit/**").hasAnyAuthority("MODIFY_SYLLABUS", "FULLACCESS_SYLLABUS")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/training-unit/**").hasAnyAuthority( "FULLACCESS_SYLLABUS")
                //training content
                .requestMatchers(HttpMethod.POST, "/api/v1/trainingContent/**").hasAnyAuthority("CREATE_SYLLABUS", "FULLACCESS_SYLLABUS")
                .requestMatchers(HttpMethod.GET, "/api/v1/trainingContent/**").hasAnyAuthority("VIEW_SYLLABUS", "FULLACCESS_SYLLABUS")
                .requestMatchers(HttpMethod.PATCH, "/api/v1/trainingContent/**").hasAnyAuthority("MODIFY_SYLLABUS", "FULLACCESS_SYLLABUS")
                .requestMatchers(HttpMethod.PUT, "/api/v1/trainingContent/**").hasAnyAuthority("MODIFY_SYLLABUS", "FULLACCESS_SYLLABUS")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/trainingContent/**").hasAnyAuthority( "FULLACCESS_SYLLABUS")
