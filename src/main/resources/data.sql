...
-- Insert table user
-- ----------------------------
INSERT INTO user (name, email, day_of_birth, gender, phone, password, status_user, role_id, create_date, modified_date, modified_by, create_by)
VALUES ('Ánh Nguyễn Nghị', 'vi.vy@hotmail.com', '2000-04-22', '0', '0335857968', '123456', 'ACTIVE', 1, '2000-04-22', '2000-04-22', 'Warrior Tran', 'Warrior Tran');
